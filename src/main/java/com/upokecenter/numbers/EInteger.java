 ...
 */
  ...
  public final class EInteger implements Comparable<EInteger> {
    ...
    public int bitLength() {
      ...
      if (wc != 0) {
        if (this.negative) {
          return this.Abs().Subtract(EInteger.FromInt64(1)).bitLength();
        }
     ...
     * operation, the big integer is treated as a two's complement
     * representation. Thus, for negative values, the arbitrary-precision
     * integer is sign-extended.
