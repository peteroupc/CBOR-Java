...
import com.upokecenter.numbers.*;
  ...
  * href='https://github.com/peteroupc/numbers-java'><code>com.github.peteroupc/numbers</code></a>
     ...
     * @deprecated Use EInteger from PeterO.Numbers/com.upokecenter.numbers and the
...
return this.getEi().GetSignedBitLength();
     ...
     *  value is negative, the bits that appear "before" the most
     * significant bit of the number will be all ones.
