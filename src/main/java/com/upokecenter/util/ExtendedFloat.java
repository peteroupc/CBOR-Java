...
import com.upokecenter.numbers.*;
     ...
     * that operation is a quiet NaN, unless noted otherwise. </p>
...
@Deprecated
  ...
  BigInteger exponent) {
     ...
     * .) <p>The format of the string generally consists of: </p> <ul>
     * <li>An optional plus sign ("+" , U+002B) or minus sign ("-", U+002D)
     * (if '-' , the value is negative.) </li> <li>One or more digits, with
