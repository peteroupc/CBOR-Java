    ...
    public void TestBuiltInTags() {
        ...
        CBORObject.DecodeFromBytes(new byte[] { (byte)0xc2, 0x40 }).AsEInteger());
      {
        ...
        Object objectTemp2 = CBORObject.DecodeFromBytes(
          new byte[] { (byte)0xc3, 0x41, 0x00 }).AsEInteger();
  ...
  CBORObject.DecodeFromBytes(new byte[] { (byte)0xc3, 0x43, 1, 0, 0 }).AsEInteger());
    ...
    public void TestStringRefs() {
      ...
      cbor = CBORObject.DecodeFromBytes(new byte[] {
        ...
        0x61, (byte)0xd8, 0x19, 0x00, (byte)0xd8, 0x19, 0x00, 0x64, 0x62, 0x62, 0x63, 0x64,
        (byte)0xd8, 0x19, 0x01, (byte)0xd8, 0x19, 0x00, (byte)0xd8, 0x19, 0x01, (byte)0xff,
       });
      expected =
