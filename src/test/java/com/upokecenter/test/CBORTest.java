...
import com.upokecenter.numbers.*;
 ...
 Assert.fail();
  ...
  cbor.AsEInteger());
      if (cbor.AsEInteger().GetSignedBitLengthAsEInteger()
            .ToInt32Checked() <= 31) {
 Assert.fail();
 }
 ...
 Assert.fail();
  ...
  ToObjectTest.TestToFromObjectRoundTrip(1625));
    ...
    public void TestSharedRefValidInteger() {
      ...
      bytes = new byte[] {
        (byte)0x82, (byte)0xd8, 0x1c, 0x00, (byte)0xd8, 0x1d, (byte)0xc4, (byte)0x82,
...
cmpCobj.toString() +
 ...
 Assert.fail();
    ...
    public void TestTags264And265() {
      ...
      // Tag 264
      cbor = CBORObject.DecodeFromBytes(new byte[] {
        (byte)0xd9, 0x01, 0x08, (byte)0x82,
        (byte)0xc2, 0x42, 2, 2, (byte)0xc2, 0x42, 2, 2,
       });
      CBORTestCommon.AssertRoundTrip(cbor);
      // Tag 265
      cbor = CBORObject.DecodeFromBytes(new byte[] {
        (byte)0xd9, 0x01, 0x09, (byte)0x82,
        (byte)0xc2, 0x42, 2, 2, (byte)0xc2, 0x42, 2, 2,
       });
      CBORTestCommon.AssertRoundTrip(cbor);
    }
