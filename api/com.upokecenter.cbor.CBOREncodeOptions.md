...
- `CBOREncodeOptions() CBOREncodeOptions`<br>
  ...
  options.
- `CBOREncodeOptions​(boolean useIndefLengthStrings, boolean allowDuplicateKeys)`<br>
  Deprecated.
  Use the more readable String constructor instead.
  Use the more readable String constructor instead.
- `CBOREncodeOptions​(boolean useIndefLengthStrings, boolean allowDuplicateKeys, boolean ctap2Canonical)`<br>
  Deprecated.
  Use the more readable String constructor instead.
  Use the more readable String constructor instead.
